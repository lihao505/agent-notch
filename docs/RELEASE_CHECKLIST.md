...
- [x] 将 Agent Bridge vendored 到主仓库，并随 Agent Notch App 同版本打包
- [ ] 重新登录 `gh`，创建 `lihao505/agent-notch` 后确认默认分支保护与 Security Advisory
- [ ] 人工视觉相似性与商标检索完成
...
任何未完成的首次发布项都必须在 Release Notes 中标为已知限制，不能用“已完全
支持”替代真实回合验收。
